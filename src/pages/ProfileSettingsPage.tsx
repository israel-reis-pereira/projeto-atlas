    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <section>
        ...
        <p className="mt-1 text-sm text-[#647067]">
          Gerencie seus dados e preferências pessoais.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-[#E3E9E5] bg-white shadow-sm">
        <div className="flex items-center gap-4 border-b border-[#E3E9E5] p-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[#647067]">
              Atualize os dados do usuário atual.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-5 p-6 sm:grid-cols-2">
          <label>
            ...
            <input
              type="text"
              defaultValue="Priscila Andrade"
              className="mt-2 w-full rounded-lg border border-[#D9E2DC] px-4 py-3 text-sm outline-none transition focus:border-[#2F6B4F] focus:ring-2 focus:ring-[#DCFCE7]"
            />
          </label>
          ...
          <label>
            ...
            <input
              type="text"
              defaultValue="Diretora de Operações"
              className="mt-2 w-full rounded-lg border border-[#D9E2DC] px-4 py-3 text-sm outline-none transition focus:border-[#2F6B4F] focus:ring-2 focus:ring-[#DCFCE7]"
            />
          </label>
          ...
          <label className="sm:col-span-2">
            ...
            <input
              type="email"
              defaultValue="priscila@rotaverdeambiental.com.br"
              className="mt-2 w-full rounded-lg border border-[#D9E2DC] px-4 py-3 text-sm outline-none transition focus:border-[#2F6B4F] focus:ring-2 focus:ring-[#DCFCE7]"
            />
          </label>
        </div>
